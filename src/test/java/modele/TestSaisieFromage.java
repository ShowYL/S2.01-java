...
public class TestSaisieFromage {
	...
	public void testSaisieFromageALaCoupe() {
		SaisieFromage uneSaisie = new SaisieFromage(null, null, null, TypeVente.A_LA_COUPE_AU_POIDS);
		assertTrue(uneSaisie.builderFromage() instanceof FromageALaCoupe);
	}

	@Test
	public void testSaisieFromageEtArticlesALaCoupe() {
		SaisieFromage uneSaisie = new SaisieFromage("Brie de Melun", "brie_de_melun",
	...
	public void testSaisieFromageALunité() {
		SaisieFromage uneSaisie = new SaisieFromage(null, null, null, TypeVente.A_L_UNITE);
		assertTrue(uneSaisie.builderFromage() instanceof FromageALUnité);
	}

	@Test
	public void testSaisieFromageEtArticleALunité() {
		SaisieFromage uneSaisie = new SaisieFromage("Brique de Brebis Fermière", "brique_de_brebis_fermiere",
	...
	public void testSaisieFromageEntierOuMoitié() {
		SaisieFromage uneSaisie = new SaisieFromage(null, null, null, TypeVente.ENTIER_OU_MOITIE);
	...
	public void testSaisieFromageEtArticlesEntierOuMoitié() {
		SaisieFromage uneSaisie = new SaisieFromage("Brin d'Amour Corse", "brin_d_amour_corse",
	...
	public void testSaisieFromageALunitéPlusieursChoix() {
		SaisieFromage uneSaisie = new SaisieFromage(null, null, null, TypeVente.A_L_UNITE_PlUSIEURS_CHOIX);
	...
	public void testSaisieFromageEtArticlesALunitéPlusieursChoix() {
		SaisieFromage uneSaisie = new SaisieFromage("Cabris Fermier", "cabris_fermier",
	...
	public void testSaisieFromagePourXPersonnes() {
		SaisieFromage uneSaisie = new SaisieFromage(null, null, null, TypeVente.POUR_X_PERSONNES);
	...
	public void testSaisieFromageEtArticlesPourXPersonnes() {
		SaisieFromage uneSaisie = new SaisieFromage("Fondue Savoyarde", "fondue_savoyarde",
