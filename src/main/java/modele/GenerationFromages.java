...
public class GenerationFromages {
	...
	public static Fromages générationBaseFromages() {
	...
	private static List<Fromage> GenerationFromageBrebis() {
		...
		SaisieFromage[] fromages = { new SaisieFromage("Brebis au Bleu", "brebis_au_bleu",
				...
				new SaisieFromage("Brique de Brebis Fermière", "brique_de_brebis_fermiere",
				...
				new SaisieFromage("Ossau Iraty", "ossau_iraty",
						...
						new String[] { "250 g", "500 g", "1 kg", "1/2 Tomme (2.1 kg environ)" },
						new float[] { 8.5F, 16.99F, 33.99F, 57.11F }),
				new SaisieFromage("Ossau Iraty - Saint Michel", "ossau_iraty__saint_michel",
				...
				new SaisieFromage("Roquefort Baragnaudes", "roquefort_baragnaudes",
	...
	private static List<Fromage> GenerationFromageChèvre() {
		...
		SaisieFromage[] fromages = { new SaisieFromage("Bouton de Culotte fermier", "bouton_de_culotte_fermier",
				...
				new SaisieFromage("Pouligny Saint Pierre", "pouligny_saint_pierre",
				...
				new SaisieFromage("Persillé de Chèvre", "persille_de_chevre",
						...
						TypeVente.A_LA_COUPE_AU_POIDS, new String[] { "250 g", "500 g" },
				...
				new SaisieFromage("Tomme de Chèvre", "tomme_de_chevre",
						...
						TypeVente.A_LA_COUPE_AU_POIDS,
						new String[] { "250 g", "500 g", "1 kg", "1/2 Tomme (2 kg environ)" },
						new float[] { 8.2F, 16.4F, 32.8F, 55.76F }),
				new SaisieFromage("Tomme de Chèvre Thym Miel", "tomme_de_chevre_thym_miel",
				...
				new SaisieFromage("Cabris Fermier", "cabris_fermier",
						...
						new String[] { "Moelleux cendré - Jeune et doux", "Moelleux blanc - Jeune et doux" },
						new float[] { 3.39F }),
				new SaisieFromage("Chabis Fermier", "chabis_fermier",
						...
						new String[] { "Moelleux cendré - Jeune et doux", "Moelleux blanc - Jeune et doux" },
						new float[] { 3.99F }),
				new SaisieFromage("Chabis frais aromatisé Fermier", "chabis_frais_aromatise_fermier",
						...
						TypeVente.A_L_UNITE_PlUSIEURS_CHOIX,
						new String[] { "Echalotes", "Ail et fines herbes", "Poivres" }, new float[] { 3.99F }),
				...
				new SaisieFromage("Crottin Fermier", "crottin_fermier",
						...
						TypeVente.A_L_UNITE_PlUSIEURS_CHOIX,
						new String[] { "moelleux (jeune et doux)", "affiné (très prononcé)" }, new float[] { 3.90F }),
				new SaisieFromage("Crottin frais aromatisé Fermier", "crottin_frais_aromatise_fermier",
						"Produit par nos soins, sous le nom de l'EARL Chemin Fleury, au lait cru de chèvre, nos crottins frais aromatisés présentent une pâte très tendre "
								...
								+ "Leurs doux goûts de chèvre uniques raviront vos papilles et celles de vos convives.",
						TypeVente.A_L_UNITE_PlUSIEURS_CHOIX,
						new String[] { "Poivre", "Echalotes", "Ail et fines herbes" }, new float[] { 2.99F }),
				new SaisieFromage("Faisselle de chèvre 500g", "faisselle_de_chevre_500g",
				...
				new SaisieFromage("Long Fermier", "long_fermier",
						...
						TypeVente.A_L_UNITE_PlUSIEURS_CHOIX,
						new String[] { "Blanc Moelleux - jeune et doux", "Cendré Moelleux - jeune et doux" },
						new float[] { 5.59F }),
				new SaisieFromage("Le Trio Apéro", "le_trio_apero",
						"Produit par nos soins, sous le nom de l'EARL Chemin Fleury, au lait cru de chèvre, nos crottins frais aromatisés présentent une pâte très tendre "
								+ "et moelleuse de couleur blanche recouverte de différentes épices : échalotes, ails et fines et herbes ou encore poivre. "
								+ "Leurs doux goûts de chèvre uniques raviront vos papilles et celles de vos convives.",
				...
				new SaisieFromage("Ovale Fermier", "ovale_fermier",
						...
						TypeVente.A_L_UNITE, new String[] { "" }, new float[] { 3.99F }),
				new SaisieFromage("Pavé Fermier", "pave_fermier",
	...
	private static List<Fromage> GenerationFromageVache() {
		...
		SaisieFromage[] fromages = { new SaisieFromage("Abondance", "abondance",
				...
				new SaisieFromage("Camembert de Normandie AOP", "camembert_de_normandie_aop",
				...
				new SaisieFromage("Comté 18 mois", "comte_18_mois",
						...
						TypeVente.A_LA_COUPE_AU_POIDS, new String[] { "250 g", "500 g", "1 Kg" },
						new float[] { 8.95F, 17.9F, 35.8F }),
				new SaisieFromage("Comté spécial de Noël", "comte_special_de_noel",
				...
				new SaisieFromage("Curé Nantais", "cure_nantais",
				...
				new SaisieFromage("Emmental de Savoie IGP", "emmental_de_savoie_igp",
				...
				new SaisieFromage("Mimolette Vieille", "mimolette_vieille",
						...
						TypeVente.A_LA_COUPE_AU_POIDS, new String[] { "200 g", "400 g", "1 Kg" },
				...
				new SaisieFromage("Raclette de Savoie", "raclette_de_savoie",
						...
						TypeVente.A_LA_COUPE_AU_POIDS,
						new String[] { "250 g", "500 g", "1 Kg", "1/2 Tomme 2,6 Kg (environ)" },
				...
				new SaisieFromage("Rosettes de tête de moine", "rosettes_de_tete_de_moine",
						...
						TypeVente.A_L_UNITE, new String[] { "" }, new float[] { 8.9F }),
				new SaisieFromage("Saint Félicien", "saint_felicien",
				...
				new SaisieFromage("Saint Marcellin Fermier", "Saint-Marcellin-fermier",
				...
				new SaisieFromage("Saint Nectaire Fermier", "saint_nectaire_fermier",
						...
						TypeVente.A_LA_COUPE_AU_POIDS,
						new String[] { "250 g", "500 g", "1 Kg", "fromage entier de 1,5 Kg (environ)" },
				...
				new SaisieFromage("Tête de Moine", "tete_de_moine",
						...
						TypeVente.A_LA_COUPE_AU_POIDS,
						new String[] { "200 g", "400 g", "Tête de Moine entière 850 g (environ)" },
				...
				new SaisieFromage("Tomme de Savoie", "tomme_de_savoie",
						...
						TypeVente.A_LA_COUPE_AU_POIDS,
						new String[] { "250 g", "500 g", "1 Kg", "tomme entière de 1,6 Kg (environ)" },
						new float[] { 5.99F, 11.99F, 23.99F, 30.7F }),
				new SaisieFromage("Tomme des Pyrénées", "tomme_des_pyrenees",
