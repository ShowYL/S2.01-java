...
public class FEN_Imprimer {
	...
	private void initialize() {
		...
		this.frame.setSize(696, 420);
		this.frame.setLocationRelativeTo(null);
		this.frame.setBackground(Constantes.GRIS_CLAIR);
		this.frame.getContentPane().setLayout(new BorderLayout(0, 0));
		...
		this.frame.getContentPane().add(panel_center, BorderLayout.CENTER);
		...
		this.rdbtnNewRadioButton = new JRadioButton("Tout");
		this.rdbtnNewRadioButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (FEN_Imprimer.this.rdbtnNewRadioButton.isSelected()) {
					FEN_Imprimer.this.rdbtnNewRadioButton_1.setSelected(false);
				}
			}
		});
		this.rdbtnNewRadioButton.setFont(new Font("Tahoma", Font.PLAIN, 14));
		panel_plage.add(this.rdbtnNewRadioButton);

		JPanel panel_2 = new JPanel();
		panel_plage.add(panel_2);
		panel_2.setLayout(new GridLayout(0, 2, 0, 0));

		this.rdbtnNewRadioButton_1 = new JRadioButton("Pages :");
		this.rdbtnNewRadioButton_1.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (FEN_Imprimer.this.rdbtnNewRadioButton_1.isSelected()) {
					FEN_Imprimer.this.rdbtnNewRadioButton.setSelected(false);
				}
			}
		});
		this.rdbtnNewRadioButton_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		panel_2.add(this.rdbtnNewRadioButton_1);
		...
		btn_quit.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				FEN_Imprimer.this.frame.dispose();
			}
		});
